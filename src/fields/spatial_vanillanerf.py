"""Classic view invariant (no direction) NeRF field"""
...
class SpatialVanillaNeRFField(Field):
    """View invariant (no direction) NeRF Field
    ...
    def __init__(
        ...
        field_heads: Tuple[FieldHead] = (SemanticFieldHead(num_classes=101),),
