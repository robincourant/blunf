"""
Field for compound nerf model with a BluNF backbone, adds scene contraction and image
embeddings to instant ngp and blueprint embeddings.
"""
...
class TCNNBlunfField(Field):
    ...
    def __init__(
        ...
        blueprint_embedding_dim: int = 16,
        ...
        self.blueprint_embedding_dim = blueprint_embedding_dim
        ...
        self.embedding_blueprint = Embedding(
            self.num_semantic_classes, self.blueprint_embedding_dim
        )
        ...
        self.mlp_semantics = tcnn.Network(
            n_input_dims=self.geo_feat_dim + self.blueprint_embedding_dim,
            n_output_dims=hidden_dim_transient,
            network_config={
                "otype": "FullyFusedMLP",
                "activation": "ReLU",
    ...
    def get_density(self, ray_samples: RaySamples):
        ...
        # base_mlp_out = base_mlp_out.clamp(-1000, 1000)
...
field_implementation_to_class = {"tcnn": TCNNBlunfField}
